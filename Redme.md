# Download Youtube using Python with Django + Tailwind

<h2> Requirements</h2>

 <ol>
    <li><h4>Install venv</h4></li>
    Type <code>python -m venv venv</code> in your terminal to install <b style="color:skyblue">virtual environment's.</b>
    <li><h4>Install Django</h4></li>
    Type <code>pip install django</code> in your terminal to install <b style="color:skyblue">Django.</b>
    <li><h4>Install Pytube</h4></li>
    Type <code>pip install pytube</code> in your terminal to install <b style="color:skyblue">Pytube.</b>
